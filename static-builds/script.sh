...
rm -rf ~/cephaloncoin ~/sign ~/release
...
find ${DISTNAME}/bin -type f -executable -exec ../cephaloncoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../cephaloncoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/cephaloncoin/temp
cd ~/cephaloncoin/temp
tar xf ../$SOURCEDIST
...
mkdir -p ~/cephaloncoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/cephaloncoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
