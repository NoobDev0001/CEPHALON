## Cephalon Metadata Specification

Additional fields may be added, but will be ignored by Cephalon.
...
```
{
   ...
   "contract_signature": "<Cephalon signed contract_hash>",
