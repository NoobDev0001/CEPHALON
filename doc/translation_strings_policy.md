...
This document provides guidelines for internationalization of the Cephalon Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cephalon_en.ts` remains unchanged.
