...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the CephalonTestFramework
    pass

class ExampleTest(CephalonTestFramework):
    # Each functional test is a subclass of the CephalonTestFramework class.
    ...
    def custom_method(self):
        ...
        CephalonTestFramework class so other tests can use it."""
