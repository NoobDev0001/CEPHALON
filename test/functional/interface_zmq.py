...
import os
import struct
from test_framework.test_framework import CephalonTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(CephalonTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that cephalon has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("cephalond has not been built with zmq enabled.")
