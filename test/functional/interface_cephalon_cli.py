...
class TestCephalonCli(CephalonTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `cephalon-cli getinfo`")
        ...
        self.log.info("Compare responses from `cephalon-cli -getinfo` and the RPCs data is retrieved from.")
