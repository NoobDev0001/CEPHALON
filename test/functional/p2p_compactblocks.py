...
# TestNode: A peer we use to send messages to cephalond, and store responses.
...
class CompactBlocksTest(CephalonTestFramework):
    ...
    # This test actually causes cephalond to (reasonably!) disconnect us, so do this last.
    ...
    # Test that cephalond requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for cephalond to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # cephalond will not send blocktxn responses for blocks whose height is
