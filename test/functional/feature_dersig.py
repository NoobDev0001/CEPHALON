...
class BIP66Test(CephalonTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # cephalond is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and cephalond produces more specific reject
            # reasons.
