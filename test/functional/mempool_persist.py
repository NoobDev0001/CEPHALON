...
By default, cephalond will dump mempool on shutdown and
...
class MempoolPersistTest(CephalonTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give cephalond a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent cephalond from writing mempool.dat to disk. Verify that `savemempool` fails")
