...
#ifndef CEPHALON_WALLET_WALLET_H
#define CEPHALON_WALLET_WALLET_H
...
public:
     ...
     * on this cephalon node, and set to 0 for transactions that were created
...
#endif // CEPHALON_WALLET_WALLET_H
