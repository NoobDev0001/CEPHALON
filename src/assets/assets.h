...
#ifndef CEPHALONCOIN_ASSET_PROTOCOL_H
#define CEPHALONCOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_CEPHALON_ASSET NEOXQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_CEPHALON_ASSET NEOXO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_CEPHALON_ASSET NEOXR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_CEPHALON_ASSET NEOXT
...
#endif //CEPHALONCOIN_ASSET_PROTOCOL_H
