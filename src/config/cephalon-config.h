/* src/config/cephalon-config.h.  Generated from cephalon-config.h.in by configure.  */
/* src/config/cephalon-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef CEPHALON_CONFIG_H

#define CEPHALON_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Cephalon Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Cephalon Core"
...
#define PACKAGE_BUGREPORT "https://github.com/CephalonChain/Cephalon/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Cephalon Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Cephalon Core 4.4.4"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cephalon"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://cephalon.net"
