/* src/config/neoxa-config.h.  Generated from neoxa-config.h.in by configure.  */
/* src/config/neoxa-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef NEOXA_CONFIG_H

#define NEOXA_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Neoxa Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Neoxa Core"
...
#define PACKAGE_BUGREPORT "https://github.com/NeoxaChain/Neoxa/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Neoxa Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Neoxa Core 4.4.4"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "neoxa"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://neoxa.net"
