...
#ifndef CEPHALON_QT_CephalonGUI_H
#define CEPHALON_QT_CephalonGUI_H
...
/**
  cephalon GUI main class. This class represents the main window of the cephalon UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class CephalonGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit CephalonGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~CephalonGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a cephalon wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif // CEPHALON_QT_CephalonGUI_H
