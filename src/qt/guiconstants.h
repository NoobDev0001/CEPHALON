...
#ifndef CEPHALON_QT_GUICONSTANTS_H
#define CEPHALON_QT_GUICONSTANTS_H
...
/* CephalonGUI -- Size of icons in status bar */
...
/* Cephalon dark orange */
#define COLOR_DARK_ORANGE QColor("#f05239")
/* Cephalon light orange */
...
/* Cephalon shadow color - light mode */
...
/* Cephalon label color as a string */
...
#define QAPP_ORG_NAME "Cephalon"
#define QAPP_ORG_DOMAIN "cephalon.org"
#define QAPP_APP_NAME_DEFAULT "Cephalon-Qt"
#define QAPP_APP_NAME_TESTNET "Cephalon-Qt-testnet"

#endif // CEPHALON_QT_GUICONSTANTS_H
