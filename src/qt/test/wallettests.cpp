...
#include "qt/cephalonamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<CephalonAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_cephalon-qt -platform xcb      # Linux
//     src/qt/test/test_cephalon-qt -platform windows  # Windows
//     src/qt/test/test_cephalon-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = CephalonUnits::formatWithUnit(unit, balance, false, CephalonUnits::separatorAlways);
    ...
    // Amount input
    CephalonAmountField* amountInput = receiveCoinsDialog.findChild<CephalonAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: cephalon:")) != -1);
