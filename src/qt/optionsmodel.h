...
#ifndef CEPHALON_QT_OPTIONSMODEL_H
#define CEPHALON_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for cephalon client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // CephalonUnits::Unit
...
#endif // CEPHALON_QT_OPTIONSMODEL_H
