...
#ifndef CEPHALON_QT_SENDASSETSENTRY_H
#define CEPHALON_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending cephalon.
...
#endif // CEPHALON_QT_SENDASSETSENTRY_H
