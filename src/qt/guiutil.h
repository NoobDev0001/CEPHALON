...
#ifndef CEPHALON_QT_GUIUTIL_H
#define CEPHALON_QT_GUIUTIL_H
...
/** Utility functions used by the cephalon Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "cephalon:" URI into recipient object, return true on successful parsing
