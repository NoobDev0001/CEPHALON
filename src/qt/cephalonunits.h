...
#ifndef CEPHALON_QT_CEPHALONUNITS_H
#define CEPHALON_QT_CEPHALONUNITS_H
...
/** cephalon unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CephalonUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CephalonUnits(QObject *parent);
...
typedef CephalonUnits::Unit CephalonUnit;

#endif // CEPHALON_QT_CEPHALONUNITS_H
