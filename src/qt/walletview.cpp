...
void WalletView::setCephalonGUI(CephalonGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? CephalonGUI::HD44_ENABLED : _walletModel->hdEnabled() ? CephalonGUI::HD_ENABLED : CephalonGUI::HD_DISABLED);
